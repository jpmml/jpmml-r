...
public class OLSConverter extends LMConverter {
	...
	public void encodeSchema(RExpEncoder encoder){
		RGenericVector ols = getObject();

		RExp terms = ols.getValue("terms");
		RGenericVector design = (RGenericVector)ols.getValue("Design");
